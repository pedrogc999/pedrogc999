...
3. **Tu tiempo real** — la rejilla semanal de disponibilidad (mañana/tarde/noche), **interactiva**: tocas las franjas y recalcula las horas y el plan (F-CFG-2). El plan se construye sobre tu vida real, no la ideal.
...
7. **Tus datos son tuyos** — ver / exportar / borrar de verdad; y el **Cuaderno de Bitácora sagrado**, solo tuyo, nunca compartido (Manifiesto 7, Doc 12 §7).
