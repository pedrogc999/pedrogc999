...
9. **Suscripción y facturas** — qué tienes contratado y cuánto pagas, sin letra pequeña (Doc 03): el **plan actual** (Anual · 9 €/mes), el recordatorio ético de que **el acompañamiento emocional es gratis para siempre**, el **cambiador de plan** (Free / Plus / Anual con prorrateo y sin permanencia), el **método de pago**, el **histórico de facturas** descargables en PDF, y **pausar o cancelar** sin trabas ni culpa. «Cancela cuando quieras».
