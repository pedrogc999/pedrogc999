...
4. **El Gantt de la Travesía** — La vista de trabajo: bloques del temario, repaso espaciado, simulacros y recta final repartidos **semana a semana** hasta el examen, con la línea de **"Hoy"**. Es el "corto/medio/largo plazo" en una sola foto temporal. Sereno y sin tareas en rojo. Es **interactivo**:
