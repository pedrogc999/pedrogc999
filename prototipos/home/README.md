...
4. **Carrusel en movimiento** — los 4 valores (Planificación · Temario · Test · Acompañamiento emocional) demostrados con **capturas reales de la app** (en `media/`, generadas desde los propios prototipos): el **Gantt** completo del Plan, la **lectura del temario** con su explicación de Faro, una **pregunta de test** real, y la **voz del preparador**. No son maquetas dibujadas: son pantallas reales con la insignia «Pantalla real de Faro» y un sutil respiro (Ken-Burns), que **se ven en cualquier visor** (no dependen de cargar la app embebida). Pestañas con barra de progreso y pausa al pasar el ratón. «Demuestra, no solo cuentes».
