...
4. **Carrusel en movimiento** — los 4 valores (Planificación · Temario · Test · Acompañamiento emocional) demostrados con **motion graphics** que auto-avanzan: el plan recolocándose, un subrayado y esquema dibujándose, un test corrigiéndose con su porqué, y un check-in con la voz de Faro. Pestañas con barra de progreso y pausa al pasar el ratón. «Demuestra, no solo cuentes».
