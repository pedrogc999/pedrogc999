...
4. **Carrusel en movimiento** — los 4 valores (Planificación · Temario · Test · Acompañamiento emocional) demostrados con **las pantallas reales de la app, en vivo**: cada slide embebe el prototipo real (vía `iframe`) enfocado a su zona clave —el **Gantt** vivo del Plan, la **lectura del temario** con su explicación de Faro, una **pregunta de test** real, y la **voz del preparador** con tus métricas—. No son maquetas: es la app de verdad, con la insignia «App real · en vivo», su tema sincronizado con la home, pestañas con barra de progreso y pausa al pasar el ratón. «Demuestra, no solo cuentes».
